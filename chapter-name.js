  ...
  for (let chapter = 1; chapter < 28; chapter++) {
    try {
      const res = await axios.get(
        `https://truyenfull.vn/ajax.php?type=list_chapter&tid=133&tascii=vu-dong-can-khon&tname=V%C5%A9+%C4%90%E1%BB%99ng+C%C3%A0n+Kh%C3%B4n&page=${chapter}&totalp=27`
      );
